        ...
        while(control){
            ...
            switch(op){
                case 1 -> {
                    ...
                    System.out.print("Ingrese una fecha como recordatorio: ");
                    date = leer.nextLine();
                    recordatorio = formato.parse(date);
                    System.out.println("Posibles estados: 1-.Completa. 2-.Incompleta.");
                    System.out.print("Ingrese el estado de la tarea: ");
                    est = leer.nextInt();
                    estado = est == 1;
                    lista.agregar(nuevaTarea, prioridad, fecha, estado, recordatorio);
                }
                case 2 -> {
